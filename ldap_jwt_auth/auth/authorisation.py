...
from ldap_jwt_auth.core import config
...
class Authorisation:
    ...
    def __init__(self) -> None:
       ...
       try:
        with open(config.authentication.user_config_path, "r") as file:
    ...
    def is_user_admin(self, roles: list[str]) -> bool:
       """
      Check if the given user's roles hold at least one role with the highest privilege level defined in the configuration.
